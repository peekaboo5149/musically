...
class NavigationDrawer extends StatelessWidget {
        ...
        child: SafeArea(
          child: Column(
            children: [
              ...
              _buildDrawerItem(
                  'Folders', Icons.folder_outlined, context, () {}),
              _buildDrawerItem(
                  'Playing Queue', Icons.playlist_play, context, () {}),
              _buildDrawerItem(
                  'Equalizer', Icons.bar_chart_outlined, context, () {}),
  ...
  Widget _buildDrawerItem(
      String name, IconData icon, BuildContext context, Function onPressed) {
    return InkWell(
